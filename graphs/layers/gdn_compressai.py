...
from utils.parametrizers import NonNegativeParametrizer
...
class GDN(nn.Module):
    ...
    """
    # i = 1;
    # self.autoencoder.ae_up[i].gamma.max();
    # self.autoencoder.ae_up[i].gamma_reparam(self.autoencoder.ae_up[i].gamma).max()
