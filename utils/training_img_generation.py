...
def save_patches_from_imgs(patch_size=256, save_percentage=35, min_num_patch_per_img=5):
    # dirs to read from and to write to
    root_rd = "/media/research/DL-Pytorch-1/CLIC/OpenImages-L3C"
    root_wr = "/media/research/DL-Pytorch-1/CLIC/OpenImages-L3C_256x256"
